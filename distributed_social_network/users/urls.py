...
urlpatterns = [
    ...
    path("friends/<str:username>", views.FriendList.as_view(), name='friends'),
    path("followers/<str:username>", views.FollowerList.as_view() , name='followers'),
    path("following/<str:username>", views.FollowingList.as_view(), name='following'),
