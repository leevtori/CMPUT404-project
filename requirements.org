...
** Requirements
   ...
   - [x] Follow the guidelines in the example-article.json for the
     URLs and services
   - [x] friend querying via POSTs to http://service/friends/userid
   - [x] friend2friend querying via GETs to http://service/author/<userid>/friends/<userid>
...
** Restrictions
   - [x] Use Python 3.6 (otherwise get approval)
   - [x] Use Django or Flask (otherwise get approval)
   - [x] Must run on one of the following:
     - [x] provided VMs
     - [x] Heroku
...
*** Project Part 0
    - 1 mark
    - [x] 4-5 CCIDs
    - [x] 1 Github repo with a README and LICENSE
*** Project Part 1
